...
``rvgen/isa/filtering.py`` is responsible for dropping the
...
from rvgen.isa.factory import define_instr, INSTR_REGISTRY, _assert_not_registered
from rvgen.isa.vector import VectorInstr, define_vector_instr
