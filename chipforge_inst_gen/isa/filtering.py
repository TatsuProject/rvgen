...
from chipforge_inst_gen.isa.factory import INSTR_REGISTRY
...
def create_instr_list(cfg: Config) -> AvailableInstrs:
    ...
    from chipforge_inst_gen.isa.enums import PrivilegedMode
...
def _compressed_3bit_set() -> frozenset:
    ...
    if _COMPRESSED_3BIT_FORMATS is None:
        from chipforge_inst_gen.isa.enums import RiscvInstrFormat as F
