...
from chipforge_inst_gen.isa.filtering import AvailableInstrs, create_instr_list
from chipforge_inst_gen.isa.utils import format_string, hart_prefix
from chipforge_inst_gen.privileged.boot import (
    gen_pre_enter_privileged_mode,
    gen_setup_misa,
)
from chipforge_inst_gen.privileged.trap import gen_trap_handler
from chipforge_inst_gen.sections.data_page import (
    DEFAULT_AMO_REGION,
    DEFAULT_MEM_REGIONS,
    gen_data_page,
    gen_stack_section,
...
from chipforge_inst_gen.sections.signature import (
    INITIALIZED,
    IN_MACHINE_MODE,
    TEST_PASS,
    emit_core_status,
...
class AsmProgramGen:
    ...
    def _gen_trap_handler_section(self) -> None:
        ...
        if self.cfg.bare_program_mode:
            return
        from chipforge_inst_gen.isa.enums import SatpMode
